...
{
    internal static readonly Bookmarks Empty = new InternalBookmarks();
    ...
    /// <returns>New <see cref="Bookmarks"/> container with all <see cref="Values"/> of each operand.</returns>
