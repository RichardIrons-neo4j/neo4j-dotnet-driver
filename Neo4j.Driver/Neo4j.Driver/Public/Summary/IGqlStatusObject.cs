...
/// <see cref="IResultSummary.GqlStatusObjects"/>
/// </summary>
/// <seealso cref="IResultSummary.GqlStatusObjects"/>
/// <since>5.23.0</since>
public interface IGqlStatusObject
{
    /// <summary>Returns the GQLSTATUS as defined by the GQL standard.</summary>
    /// <returns>The GQLSTATUS value.</returns>
    string GqlStatus { get; }

    /// <summary>The GQLSTATUS description.</summary>
    /// <returns>The GQLSTATUS description.</returns>
    string StatusDescription { get; }

    /// <summary>
    /// Gets the position in the query where the <see cref="IGqlStatusObject"/> instance points to. Not all
    /// notifications have a unique position to point to and in that case the position would be set to all 0s.
    /// </summary>
    ...
    /// <summary>
    /// Gets the unparsed string value for <see cref="Classification"/> of the <see cref="IGqlStatusObject"/>
    /// instance.
    /// </summary>
    ...
    /// <summary>Gets the GQL Status diagnostic record.</summary>
    /// <returns>The diagnostic record as a dictionary.</returns>
    IReadOnlyDictionary<string, object> DiagnosticRecord { get; }

    /// <summary>Gets the GQL Status as string representation</summary>
