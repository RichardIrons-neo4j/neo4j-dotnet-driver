...
public sealed class TransactionConfig
{
    ...
    /// <summary>Constructor with two optional parameters</summary>
    /// <param name="metadata">A dictionary of key-value pairs to attach as metadata to the transaction.</param>
    /// <param name="timeout">
    /// The transaction timeout. Transactions running longer than this duration will be terminated by the
    /// database. If null, the server's default timeout is used. A value of zero means the transaction will execute
    /// indefinitely.
    /// </param>
