...
/// <summary>Translates a string from one naming convention to another.</summary>
...
public class ConventionTranslator<T>(
    IIdentifierParser<T> objectIdentifierParser,
    IFieldFormatter<T> recordFieldFormatter)
